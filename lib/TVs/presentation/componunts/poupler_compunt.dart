...
class PouplerCompount extends StatelessWidget {
  const PouplerCompount({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesBloc,MoviesState>(
        buildWhen: (previous, current)=> previous.pouplerState !=current.pouplerState,
      builder: (context,state){
        switch(state.pouplerState){
            ...
            return FadeIn(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: state.pouplerMovies.length,
                  itemBuilder: (context, index) {
                    final movie = state.pouplerMovies[index];
                    return Container(
