...
import 'package:clean_archticture2/core/utils/dummy%202.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context)=>sl<MovieDetailsBloc>()..add(GetMovieDetailsEvent(id))..add(GetMovieRecommendetionEvent(id)),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetails!.relaseData.split('-')[0],
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movieDetails!
                                .geners)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
